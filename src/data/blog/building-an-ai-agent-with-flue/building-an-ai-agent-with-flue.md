...
Create `.flue/workflows/generate.ts`. Start by importing the writer skill. This uses a build-time import attribute that tells the Flue CLI to bundle the markdown file as a skill reference:
