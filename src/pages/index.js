      ...
      <div className="container">
        ...
        <section className="section">
          ...
          <p>
            ...
            Development basics, Node.js, React.js, and more. I love being able
            to put the things I've learned into a package for others to learn
            from. My goal is to put in the long hard hours so you don't have to!
          </p>
        </section>
        <section className="section">
          <h2 className="h2">
