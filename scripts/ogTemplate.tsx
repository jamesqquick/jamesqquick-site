...
const SAFE = 96; // px inset from each edge (scaled for 1920×1080)
...
const LOGO_W = 242;
const LOGO_H = Math.round((LOGO_W / 337) * 57); // ≈ 41
...
function CoverTemplate({
  ...
  const titleSize = title.length > 80 ? 60 : title.length > 55 ? 76 : 96;
